      ...
      <article className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-8 text-center mt-12">
            ...
            <a href="https://wa.me/34644905837" target="_blank" rel="noopener noreferrer" onClick={() => { import("../lib/analytics").then(m => m.trackEvent("click_whatsapp", { cta_location: "blog_post" })) }} className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-cta text-white font-semibold shadow-glow hover:scale-[1.02] transition">
