...
export const Route = createFileRoute('/web-para-talleres-mecanicos')({
  head: () => {
    const sectorName = VALID_SECTORS["talleres-mecanicos"];
    return {
      meta: [
  ...
  component: () => <SectorPillar sector="talleres-mecanicos" />
})
