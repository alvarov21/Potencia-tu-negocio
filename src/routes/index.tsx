  ...
  return (
    <section id="nosotros" className="relative py-24 lg:py-32 px-6 lg:px-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="max-w-3xl">
          <span className="text-xs font-semibold tracking-[0.1em] text-primary uppercase mb-4 inline-block">No hacemos webs genéricas. Resolvemos problemas de tu sector.</span>
