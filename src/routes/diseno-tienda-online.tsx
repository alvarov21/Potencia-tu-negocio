...
export const Route = createFileRoute("/diseno-tienda-online")({
  head: () => ({
    meta: [
      { title: "diseño tienda online | Potencia tu Negocio" },
      { name: "description", content: "Expertos en diseño tienda online para captar más clientes." }
    ]
  }),
  component: DisenoTiendaOnline,
});

function DisenoTiendaOnline() {
  return (
    <div className="min-h-screen bg-background text-foreground pt-32 px-6 lg:px-10">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-muted-foreground mb-10">
          Atrae y convierte más clientes con nuestro servicio de diseño tienda online.
        </p>
