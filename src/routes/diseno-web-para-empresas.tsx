      ...
      <section id="contacto" className="py-24 lg:py-32 px-6 lg:px-10 bg-muted/30 border-t border-border">
         <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex justify-center gap-4">
              <a href="mailto:info@potenciatunegocio.eu" onClick={() => { import("../lib/analytics").then(m => m.trackEvent("click_email", { cta_location: "diseno_empresas_cta" })) }} className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-cta font-semibold shadow-glow hover:scale-[1.02] transition text-white">
