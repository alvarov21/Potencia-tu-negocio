        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            <article className="relative bg-card border-2 border-primary rounded-3xl p-8 flex flex-col shadow-glow">
              ...
              <div className="mb-6 mt-4">
                <div className="flex items-baseline gap-1.5"><span className="text-5xl font-black text-foreground">375€</span></div>
                <div className="text-sm text-muted-foreground mt-2 leading-snug">Primer año incluido &middot; después 89€/año</div>
              </div>
              <ul className="space-y-3 mb-8 text-sm mt-auto">
            ...
            <article className="bg-card border border-border rounded-3xl p-8 flex flex-col">
              ...
              <div className="mb-6 mt-4">
                <div className="flex items-baseline gap-1.5"><span className="text-5xl font-black text-foreground">595€</span><span className="text-sm text-muted-foreground">+75€/mes</span></div>
              </div>
              <ul className="space-y-3 mb-8 text-sm mt-auto">
