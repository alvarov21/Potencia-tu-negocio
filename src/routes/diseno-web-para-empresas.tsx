        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            <article className="bg-card border border-border rounded-3xl p-8 flex flex-col">
              ...
              <div className="mb-6 mt-4">
                <div className="flex items-baseline gap-1.5"><span className="text-5xl font-black text-foreground">825€</span><span className="text-sm text-muted-foreground">+65,9€/mes</span></div>
                <div className="text-sm text-muted-foreground mt-2 leading-snug">
                  Mantenimiento incluido &middot; 65,9€/mes<br />
